...
const dbUser = 'user_dtds_project';
const dbPassword = 'user_dtds_project';
...
const connect = () => {
    mongoose.connect(`mongodb+srv://${dbUser}:${dbPassword}@cluster0.agqtn0k.mongodb.net/?retryWrites=true&w=majority`, {
